...
export type RoomInfo = {
  roomCode: string;
  status: "waiting" | "active" | "between_rounds" | "completed" | "expired";
  creatorName: string;
...
export type RoomResult = {
  roomCode: string;
  seriesWinner: "creator" | "opponent" | "draw";
  seriesLength: number;
  creatorScore: number;
  opponentScore: number;
  creatorName: string;
...
export type GameStartData = {
  ...
  countdown: number;
  previousGuesses?: { guess: string; statuses: string[]; isCorrect: boolean }[];
...
export type RoundOverData = {
  roundWinner: "creator" | "opponent" | "draw";
  roundNumber: number;
  seriesLength: number;
  creatorScore: number;
  opponentScore: number;
...
export type SeriesAcceptedData = {
  seriesLength: number;
  creatorScore: number;
  opponentScore: number;
  currentRound: number;
